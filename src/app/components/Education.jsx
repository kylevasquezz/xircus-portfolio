  ...
  return (
    <HStack mx="20%" spacing={20} my={20} justify="center">
      ...
      <Stack spacing={10}>
        ...
        <Box>
          <Heading fontWeight={200} size="lg" py={8}>Experience</Heading>
        ...
        <Box>
          <Heading fontWeight={200} size="lg" py={8}>Competences</Heading>
        ...
        <Box>
          <Heading fontWeight={200} size="lg" py={8}>Tools</Heading>
