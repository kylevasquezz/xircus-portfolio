...
const About = () => {
  return (
    <Box w="100%" my={20} >
      ...
      <Box bg="gray.100" my={20} py={10}>
        <Heading fontWeight={400} size="lg" align="center" py={10}>Biography</Heading>
        <Text fontWeight={400} fontSize="sm" mx="20%" letterSpacing={1} textAlign="center">
